...
def get_java_config(fnam, app_name):
    with open('config/'+app_name+'/java_config.json', 'r') as f:
        test_lang_cfg = json.load(f)
    with open('config/'+app_name+'/variables.json', 'r') as f:
        java_vars = json.load(f)
    with open('config/'+app_name+'/model_lang_map.json', 'r') as f:
        model_lang_map = json.load(f)
